...
function fileType(filename) {
  ...
  const types = {
    ...
    ".asmdef": "Docs & Config",
    ".unity": "Unity Scene",
    ".prefab": "Unity Assets & Config",
    ".asset": "Unity Assets & Config",
    ".anim": "Unity Assets & Config",
    ".controller": "Unity Assets & Config",
    ".overridecontroller": "Unity Assets & Config",
    ".mat": "Unity Assets & Config",
    ".shader": "Unity Assets & Config",
    ".shadergraph": "Unity Assets & Config",
    ".inputactions": "Unity Assets & Config",
    ".spriteatlas": "Unity Assets & Config",
    ".lighting": "Unity Assets & Config",
    ".rendertexture": "Unity Assets & Config",
    ".physicmaterial2d": "Unity Assets & Config",
    ".uss": "Unity Assets & Config",
    ".uxml": "Unity Assets & Config",
    ".meta": "Unity Metadata",
    ".sh": "Shell",
  };
